...
@ManagedBean
@ViewScoped
public class CooperativaBean implements Serializable {
    ...
    public void localiza(ActionEvent actionEvent) {
        ...
        try {
            if ("nome".equals(this.tipoBusca)) {
                listacid = cidadaoDAO.getList(this.busca, EnumTipoPessoa.COOP);
            }
            if ("cpf".equals(this.tipoBusca)) {
                listacid = cidadaoDAO.getListByCnp(this.busca, EnumTipoPessoa.COOP);
            }
            if (listacid.isEmpty()) {
                throw new Exception();
            }
    ...
    public void newCoop(ActionEvent actionEvent) {
    ...
    public void saveCoopNew(ActionEvent actionEvent) {
        ...
        if (cidadaoDAO.getListByCnp(this.cooperativa.getCpf()).isEmpty()) {
            ...
            facesutils.aviso("CNPJ " + this.cooperativa.getCpf() + " Já Existe ");
            success = false;
        }
