...
(select count(e.cidadao_id) from mci_equipamentossecretaria e where e.cidadao_id = c.id) as qtd_Equipamentos,
(select sum(e.valor) from mci_equipamentossecretaria e where e.cidadao_id = c.id) as Investimento    
